...
def session_start(
    ...
    *,
    ...
    if scope == "user" and should_suppress_user_adapter("codex", project):
        return {}
    context = render_effective_catalog(
        project, registry_root, audit,
        session_id=str(input_data["session_id"]) if input_data.get("session_id") else None,
